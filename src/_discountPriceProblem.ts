// // Problema: Calculo de descuento para diferentes productos

// function calcularDescuento(precio: number, descuento: number) {
//   return precio - precio * descuento;
// }

// const DESCUENTO = 0.1; // 10% de descuento para todos los productos

// function calcularDescuentoProductoA(precio: number) {
//   return calcularDescuento(precio, DESCUENTO);
// }

// function calcularDescuentoProductoB(precio: number) {
//   return calcularDescuento(precio, DESCUENTO);
// }

// function calcularDescuentoProductoC(precio: number) {
//   return calcularDescuento(precio, DESCUENTO);
// }

// console.log(calcularDescuentoProductoA(100));
// console.log(calcularDescuentoProductoB(200));
// console.log(calcularDescuentoProductoC(300));
