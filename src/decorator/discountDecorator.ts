...
// console.log(`${baseProduct.name}: $${discountedProduct.getPrice()}`);

// const discountedProductHalf = new DiscountDecorator(baseProduct, 0.50);
// console.log(`${baseProduct.name}: $${discountedProductHalf.getPrice()}`);