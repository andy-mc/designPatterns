...
console.log("goblin2.attack:", goblin2.attack);
console.log("goblin2.defense:", goblin2.defense);

let goblin3 = new GoblinKing(game);

console.log("goblin3.attack:", goblin3.attack);
console.log("goblin3.defense:", goblin3.defense);
